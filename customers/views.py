...
from tenant_only.models import UploadFile, TableOne, TableTwo
...
class TenantTestView(TemplateView):
    template_name = "test.html"

    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context['tenants_list'] = Client.objects.all()
        context['tableone_list'] = TableOne.objects.all()
        context['tabletwo_list'] = TableTwo.objects.all()
        return context
